...
saving_path = "C:/yousavingpathhere"
files_path  = "C:/youfilepathhere"

# Change based on your data type
raw_data = pd.read_stata(f"{files_path}/pre_survival.dta")
...
matched_data.to_stata(f"{files_path}/{output_filename}.dta", write_index=False)
